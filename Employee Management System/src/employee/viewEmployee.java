...
class viewEmployee implements ActionListener {
    ...
    viewEmployee(){
        ...
        l1.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("employee/icons/viewEmployee.jpg"));
        l1.setIcon(img);
        ...
        Font F1 = new Font("lato",Font.BOLD,30);
        l2.setFont(F1); 
        l1.add(l2);
        f.add(l1);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            f.setVisible(false);
            printInformation p=new printInformation(t.getText());
        }
