...
class removeEmployee implements ActionListener {
    ...
    removeEmployee(){
        ...
        l5.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("employee/icons/removeEmployee.jpg"));
        l5.setIcon(img);
        f.add(l5);
        ...
        Font f2 = new Font("lato",Font.BOLD,25); 
        l1.setFont(f2);
        l5.add(l1);
        ...
        Font f3 = new Font("lato",Font.BOLD,20); 
        l2.setFont(f3);
        l5.add(l2);
        ...
        Font F6=new Font("lato",Font.BOLD,20); 
        l6.setFont(F6);
        l5.add(l6);
        ...
        Font f4 = new Font("lato",Font.BOLD,20); 
        l3.setFont(f4);
        l5.add(l3);
        ...
        Font F7=new Font("lato",Font.BOLD,20); 
        l7.setFont(F7);
        l5.add(l7);
        ...
        Font F5=new Font("lato",Font.BOLD,20); 
        l4.setFont(F5);
        l5.add(l4);
        ...
        Font f8=new Font("lato",Font.BOLD,20); 
        l8.setFont(f8);
        l5.add(l8);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){
            try{
                ...
                JOptionPane.showMessageDialog(null,"Exception occured while delating record "+ex);
            }
        }
        if(ae.getSource()==b2){
            f.setVisible(false);
