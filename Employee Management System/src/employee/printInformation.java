...
class printInformation implements ActionListener {
    ...
    printInformation(String e_id){
        ...
        f = new JFrame("Print Information");
        f.setVisible(true);
        f.setSize(595,642);
    ...
    public static void main(String[] args){
        new printInformation("Print Information");
    }
