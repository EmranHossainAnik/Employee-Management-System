...
class addEmployee implements ActionListener{
    ...
    addEmployee(){
        ...
        id9.setFont(new Font("lato",Font.BOLD,20));    
        id15.add(id9);
        ...
        id10.setFont(new Font("lato",Font.BOLD,20));
        id15.add(id10);
        ...
        id11.setFont(new Font("lato",Font.BOLD,20));
        id15.add(id11);
        ...
        id12.setFont(new Font("lato",Font.BOLD,20));
        id15.add(id12);
